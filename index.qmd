...
favicon: favicon.png
site-url: https://jc4st.github.io/pocus-nefro/
open-graph: true
twitter-card: true
google-scholar: true
language: es
...
### Día 1: VExUS, Ecografía Pulmonar y Ecocardiografía básica (foCUS)
...
-   **Diagnóstica**: Quiz previo (antes del Día 1)
-   **Formativa**: Checklist durante práctica guiada + discusión
-   **Sumativa**: Mini-CEX (opcional) + Quiz final
...
![Valentina Perdomo](img/val.jpeg){width="500"}

![Alejandra Molano](img/alejandra.jpeg){width="500"}
